...
class CajaResourceIT {
    ...
    private static final BigDecimal DEFAULT_VALOR_DIA = new BigDecimal(1);
    private static final BigDecimal UPDATED_VALOR_DIA = new BigDecimal(2);
    ...
    void createCaja() throws Exception {
        ...
        assertThat(testCaja.getValorDia()).isEqualByComparingTo(DEFAULT_VALOR_DIA);
        assertThat(testCaja.getValorRegistrado()).isEqualByComparingTo(DEFAULT_VALOR_REGISTRADO);
    ...
    void getAllCajas() throws Exception {
        ...
        restCajaMockMvc
            ...
            .andExpect(jsonPath("$.[*].valorDia").value(hasItem(sameNumber(DEFAULT_VALOR_DIA))))
    ...
    void getCaja() throws Exception {
        ...
        restCajaMockMvc
            ...
            .andExpect(jsonPath("$.valorDia").value(sameNumber(DEFAULT_VALOR_DIA)))
    ...
    void putNewCaja() throws Exception {
        ...
        assertThat(testCaja.getValorDia()).isEqualByComparingTo(UPDATED_VALOR_DIA);
        assertThat(testCaja.getValorRegistrado()).isEqualByComparingTo(UPDATED_VALOR_REGISTRADO);
